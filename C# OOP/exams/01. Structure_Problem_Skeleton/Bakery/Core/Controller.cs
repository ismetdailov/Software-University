...
namespace Bakery.Core
{
    public class Controller : IController
    {
        ...
        public Controller()
        {
            backedFoods = new List<IBakedFood>();
        ...
        public string AddFood(string type, string name, decimal price)
        {
            ...
            if (type == "Bread")
            {
                this.backedFoods.Add(new Bread(name, price));
            }
             if (type == "Cake")
            {
                this.backedFoods.Add(new Cake(name, price));
            }
        ...
        public string OrderFood(int tableNumber, string foodName)
        {
            ...
            {
                IBakedFood food = backedFoods.FirstOrDefault(f => f.Name == foodName);
                if (food == null)
                {
