namespace VaporStore.DataProcessor
{
    ...
    public static class Deserializer
	{
		public static string ImportGames(VaporStoreDbContext context, string jsonString)
		{
			...
			var games = JsonConvert.DeserializeObject<IEnumerable<GameJsonInportModel>>(jsonString);
            foreach (var jsonGame in games)
            {
				...
				var devolper = context.Developers.FirstOrDefault(x => x.Name == jsonGame.Developer)
		...
		public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
		{
			...
			var xmlSerializer = new XmlSerializer(
				typeof(PurchaseModelInputModel[]),
			...
			var purchases = // ТУК ПОЛУЧАВАМЕ ДАННИТЕ
				(PurchaseModelInputModel[])xmlSerializer.Deserialize(
