    ...
    public class Deserializer
    {
        public static string ImportDepartmentsCells(SoftJailDbContext context, string jsonString)
        {
            ...
            var departmentsCells =
                JsonConvert.DeserializeObject<IEnumerable<DepartmentCellInputModel>>
                    (jsonString);
        ...
        public static string ImportPrisonersMails(SoftJailDbContext context, string jsonString)
        {
            ...
            var prisionerMails = JsonConvert.DeserializeObject<IEnumerable<PrisionerMailInputModel>>(jsonString);
            foreach (var currentPrisoner in prisionerMails)
            {
                ...
                var isValidReleaseDate = DateTime.TryParseExact(currentPrisoner.ReleaseDate,
        ...
        private static string OfficerPrisonerInputModel(string xmlString, string v)
        {
