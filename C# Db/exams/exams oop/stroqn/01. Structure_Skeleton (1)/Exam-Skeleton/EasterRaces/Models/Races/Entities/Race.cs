...
namespace EasterRaces.Models.Races.Entities
{
    public class Race : IRace
    {
      ...
      //  IReadOnlyCollection<IDriver> IRace.Drivers => throw new NotImplementedException();

        void IRace.AddDriver(IDriver driver)
    {
            if (driver == null)
            {
                throw new ArgumentNullException(nameof(IDriver), "Driver connot be null.");
            }
