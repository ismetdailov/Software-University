...
Purpose VARCHAR(11) CHECK(Purpose IN ('Medica','Technical','Educational','Educational'))NOT NULL,
...
JobDuringJourney VARCHAR(8) CHECK(JobDuringJourney IN('Pilot','Engineer','Trooper','Cleaner')) NOT NULL,
